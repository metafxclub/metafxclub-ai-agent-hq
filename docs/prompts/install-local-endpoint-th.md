...
13. ถามผู้ใช้ว่าจะเปิด Bridge อัตโนมัติหลังเข้าสู่ Windows หรือไม่ หากตอบตกลง ให้รัน `scripts/register-bridge-autostart.cmd` จากชุดติดตั้งถาวร และยืนยันว่า Scheduled Task ของผู้ใช้ปัจจุบันถูกสร้างสำเร็จ
